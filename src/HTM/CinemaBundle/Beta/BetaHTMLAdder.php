<?php
// src/HTM/CinemaBundle/Beta/BetaHTMLAdder.php

namespace HTM\CinemaBundle\Beta;
...
class BetaHTMLAdder
{
    ...
    public function addBeta(Response $response, $remainingDays)
    {
        ...
        $html = '<div style="position: relative; top: 0; background: orange; width: 100%; text-align: center; padding: 0.5em;">Beta J-'.(int) $remainingDays.' !</div>';
